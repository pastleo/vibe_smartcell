defmodule LlmProvider.Ollama do
  ...
  @impl true
  def config_additional_info, do: "Ollama runs locally by default on port 11434. Make sure Ollama is installed and running. Visit https://ollama.com for installation instructions."
  ...
  defp handle_ollama_response(response, id, pid, chunk_acc, result_acc) do
    case response do
      ...
      %HTTPoison.AsyncChunk{id: ^id, chunk: chunk} ->
        ...
        {text, incomplete_chunk_line} = parse_response_chunk_lines(
